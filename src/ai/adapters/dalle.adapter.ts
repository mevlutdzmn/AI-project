        ...
        messages: [
          {
            role: 'system',
            content:
              'You are a translator. Translate the following image generation prompt to English. Keep it concise and suitable for DALL-E. Only output the translated prompt, nothing else.',
          },
          {
            role: 'user',
            content: prompt,
